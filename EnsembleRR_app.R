...
ui <- shinyUI(fluidPage(#
  ...
  sidebarLayout(#
    sidebarPanel(strong("Important")," This models predictions are based on observations of avalanches from people like you.  This is a tool, just like an ECT.  Be conservative in your judgement.  Play with the model, you will notice that an increase in snowfall leads to a decrease in the probability of an avalanche occuring, this is likely due to a bias in the sampling.  Nonetheless, this forecaster is not perfect.", br(), br(), "In short:", strong("Use at your own risk... skull and crossbones!"),
                 br(), br(),#
    ...
    mainPanel(br(),br(),br(), br(),br(),br(),br(),br(),br(),br(),br(), br(),br(),"Based on reported historical observations and the inputs you supplied.", br(), strong("The probability that you will encounter an avalanche is "), h2(textOutput("results1")), width = 4)),
  "This probability was created to provide another tool in evaluating danger in the backcountry.  The probability is generated by datasets provided by the Utah Avalanche Center, and the NOAA, which populate 13 different models.  All of the models have an 95% confidence interval of at least 68%-77%, a sensitivity of at least 43% and a specificity of at least 76%.  If you would like to contribute please visit the project page at ", 
