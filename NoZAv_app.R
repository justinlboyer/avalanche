...
# Load model
load("NoZrr.fit_PSSTTW.rda")
load("NoZrr.bestlam.R")
...
ui <- shinyUI(fluidPage(#
  ...
  "This model was created to provide another tool in evaluating danger in the backcountry.  The model was generated by datasets provided by the Utah Avalanche Center, and the NOAA.  The model was populated using ridge regression, and has an approximate accuracy normally distributed about 51% with a standard deviation of 5%.  If you would like to contribute please visit the project page at ", 
  a("https://github.com/justinlboyer/avalanche", href = "https://github.com/justinlboyer/avalanche"), br(), "If you post observations, please try to always include elevation, and location so that I can include these in a future version.", br(), br()
  )#
)
